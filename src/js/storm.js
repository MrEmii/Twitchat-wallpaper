...
var snowStorm = (function(window, document) {
  ...
  this.create = function create(tag, html) {
    var element = document.createElement(tag);
    element.innerHTML = html.trim();
    return element;
  };

  this.SnowFlake = function(type, content) {
    var s = this;
    this.type = type;
  ...
  this.createSnow = function(limit, data, allowInactive) {
    var i;
    storm.flakes[storm.flakes.length] = new storm.SnowFlake(parseInt(rnd(flakeTypes),10), data);
    if (allowInactive || storm.flakes.length>storm.flakesMaxActive) {
  ...
  this.init = function() {
    ...
    ipcRenderer.on('add:chat', (event, data)=>{
      storm.createSnow(storm.flakesMax, data); // create initial batch
    })
